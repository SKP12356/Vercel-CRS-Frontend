                ...
                <form onSubmit={(event) => handleChanges(event)}>
                  <h2 className="text-xl font-semibold text-gray-800 mb-6 pb-2 border-b border-gray-100 flex items-center">
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        d="M10 9a3 3 0 100-6a3 3 0 000 6zm-7 9a7 7 0 1114 0H3z"
                        clipRule="evenodd"
                      />
                    </svg>
            ...
            {activeTab === "security" && (
              <div>
                ...
                <div className="space-y-6">
                  <form
                    onSubmit={(event) => handlePassword(event)}
                        ...
                        <div className="flex items-center">
                          ...
                          <div className="ml-3">
                            <p className="text-sm text-gray-600">
                              For security reasons, use a strong password that
